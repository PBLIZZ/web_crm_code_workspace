            ...
            <div class="flex flex-col bg-gradient-to-b from-teal-900/80 to-teal-950/90 backdrop-blur-sm rounded-xl border border-teal-700/30 shadow-lg hover:shadow-xl hover:border-2 hover:border-purple-500 transition-all duration-300 transform hover:-translate-y-1 overflow-hidden group relative">
                ...
                <div class="p-8 flex-grow">
                    ...
                    <ul class="space-y-3 text-sm mb-6 feature-list">
                        ...
                        <!-- Hidden Features -->
                        <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Basic Task Management</span></li>
                        <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Data Import (CSV)</span></li>
                        <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300"><strong>AI Credit Use:</strong> ~50 Reminders OR 15 AI Email Drafts / mo</span></li>
                    </ul>
                ...
                <div class="p-8 flex-grow">
                    ...
                    <ul class="space-y-3 text-sm mb-6 feature-list">
                        ...
                        <li class="flex items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Social Media Content Planner & AI Ideas</span></li>
                         <!-- Hidden Features -->
                        <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Basic Segmentation</span></li>
                        <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Built-in Email Marketing</span></li>
                        <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Communication Tracking</span></li>
                        <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Basic Reports & Dashboards</span></li>
                    ...
                    <p class="font-semibold text-teal-400 mb-4 text-sm">Includes 2500 AI Credits / month</p>
                     <ul class="space-y-3 text-sm mb-6 feature-list">
                        ...
                        <li class="flex items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Advanced AI Analytics & Insights</span></li>
                         <!-- Hidden Features -->
                         <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Full Customization Options</span></li>
                         <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Advanced Segmentation</span></li>
                         <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Membership & Loyalty Engine</span></li>
                         <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Client Portal Access</span></li>
                         <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Social Media Auto-Posting</span></li>
                         <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">HIPAA / GDPR Compliance Tools</span></li>
                         <li class="feature-hidden hidden items-start"><svg class="h-5 w-5 text-orange-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg><span class="text-gray-300">Priority Onboarding & Support</span></li>
